...
SUBDIR_PATTERN = os.environ.get("SUBDIR_PATTERN", "*_groups")

# 2. 目标文件的扩展名
FILE_TAG = os.environ.get("FILE_TAG", ".fasta")
...
NUM_CPU = int(os.environ.get("NUM_CPU", str(TOTAL_CORES)))
# 每个MAFFT进程使用的线程数 (对于大量小文件, 1是最高效的)
THREAD_PER_JOB = int(os.environ.get("THREAD_PER_JOB", "1"))
